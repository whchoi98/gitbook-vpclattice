...
"VPC"- "PrivateLink and Lattice" 메뉴에서 Target groups 를 선택하고, "Create target group"을 선택합니다.
...
화면 하단의 "VPC Lattice integration options" 에서 "Edit"를 선택합니다.

* Auto Scaling groups Name - xxxx-RatesASG-xxxx
* integration options - Edit 선택
...
"VPC"- "PrivateLink and Lattice" 메뉴에서 아래와 같이 정상적으로 생성되었는지 확인합니다.
